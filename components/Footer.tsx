      ...
      <Container className="py-16">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="text-sm text-slate-400">Dedicated onboarding support</li>
            </ul>
        ...
        <div className="mt-12 border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-sm text-slate-500">
            <a href="mailto:contact@smartshipright.com" className="hover:text-slate-300 transition-colors">contact@smartshipright.com</a>
          </div>
        </div>
      </Container>
    </footer>
