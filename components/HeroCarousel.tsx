...
const slides = [
  ...
  {
    src: '/screenshots/picking.png',
    alt: 'Picking dashboard with batch management, tote assignment, and progress tracking',
  ...
  },
  {
    ...
    alt: 'Packing hub with scan verification and label generation',
