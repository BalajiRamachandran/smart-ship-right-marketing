            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-slate-100">
                {[
                  ...
                  { feature: 'Single-batch picking', starter: true, pro: true, enterprise: true },
                  { feature: 'Multi-batch picking', starter: false, pro: true, enterprise: true },
                  ...
                  { feature: 'Direct-to-printer support', starter: false, pro: true, enterprise: true },
